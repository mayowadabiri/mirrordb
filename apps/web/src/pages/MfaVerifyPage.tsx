...
import { useConfirmMfaSetup } from '../api/mfa'
...
export default function MfaVerifyPage() {
    const { setupId } = useParams({ from: '/mfa/$setupId/verify' })
    const navigate = useNavigate()
    const { mutateAsync, isPending, isError, error, reset } = useConfirmMfaSetup()
            ...
            <div className="w-full max-w-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex gap-3">
                        <button
                            type="button"
                            onClick={() => window.location.href = `/mfa/${setupId}/start`}
                            disabled={isPending}
